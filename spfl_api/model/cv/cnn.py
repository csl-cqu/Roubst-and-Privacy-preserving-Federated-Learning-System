...
class CNN_OriginalFedAvg(torch.nn.Module):
    ...
    def __init__(self, only_digits=True):
        ...
        self.unflatten = torch.nn.Unflatten(2, (28, 28))
        self.conv2d_1 = torch.nn.Conv2d(1, 2, kernel_size=5)
        self.max_pooling = nn.MaxPool2d(2, stride=2)
        self.conv2d_2 = torch.nn.Conv2d(2, 4, kernel_size=5)
        self.flatten = nn.Flatten()
        self.linear = nn.Linear(4 * 4 * 4, 10 if only_digits else 62)
        self.relu = nn.ReLU()
...
class ConvNet(torch.nn.Module):
    """ConvNetBN. Imported from reconstruction - ZZJ"""
